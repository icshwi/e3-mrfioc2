...
# PCIID - PCI address
# assumes that the image repo is ../../../../hwi-fw/mrf/ = TOP/../../
...
# iocshLoad("$(TOP)/iocsh/img.iocsh", "DEV=EVR6, EVR='', BIN_WR='', PCIID=$(MTCA_5U_PCIID6), BIN_FILE='$(TOP)/../../hwi-fw/mrf/mTCA-EVR-300DC-18070207.bit'")
# iocshLoad("$(TOP)/iocsh/img.iocsh", "DEV=EVR7, EVR='', BIN_WR='', PCIID=$(MTCA_5U_PCIID7), BIN_FILE='$(TOP)/../../hwi-fw/mrf/mTCA-EVR-300DC-18070207.bit'")
